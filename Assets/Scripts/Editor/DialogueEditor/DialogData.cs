...
public class DialogEntry
{
    ...
    public List<DialogOption> options;//对话选项（可选）
    public string nextDialogueId;//下一条对话ID（为空则结束对话）
    public List<DialogEvent> events;//对话触发的事件列表
}
...
public class DialogOption
{
    ...
    public List<DialogEvent> events;//选择时触发的事件
}
...
public class DialogData : ScriptableObject
{
    ...
    public List<DialogCharacter> characters = new List<DialogCharacter>();//参与对话的人物列表
    public List<DialogEntry> dialogueEntries = new List<DialogEntry>();//对话内容列表
